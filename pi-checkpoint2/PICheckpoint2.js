...
let pipoca = function()
{
    ...
    if (respPipoca=='s')
    {
        if (tempo < 10)
            ...
            function preparoSegundos(){console.log("Tempo Insucifiênte. :-|")}
            setTimeout(preparoSegundos, 1000*tempo)}

        else if (tempo >= 10 && tempo < 20)
            {console.log("Preparando...")
            function preparoSegundos(){console.log("Prato Pronto, bom apetite. :D")}
            setTimeout(preparoSegundos, 1000*tempo)}

        else if (tempo >= 20 && tempo < 30)
            {console.log("Preparando...")
            function preparoSegundos(){console.log("A comida queimou. :(")}
            setTimeout(preparoSegundos, 1000*tempo)}

        else if (tempo >= 30)
            {console.log("Preparando...")
            function preparoSegundos(){console.log("KaaBUMMM!!! -_-")}
            setTimeout(preparoSegundos, 1000*tempo)}
    }
    else
    {
        // Instrução para o tempo padrão de preparo
        console.log("Preparando...")
        function dezSegundos(){console.log("10 segundos. Prato Pronto, bom apetite")}
...
let carne = function()
{
    ...
    else
    {
        // Instrução para o tempo padrão de preparo
          console.log("Preparando...")
          function quinzeSegundos(){console.log("15 segundos. Prato Pronto, bom apetite")}
...
let feijao = function()
{
    ...
    else
    {
        // Instrução para o tempo padrão de preparo
          console.log("Preparando...")
          function dozeSegundos(){console.log("12 segundos. Prato Pronto, bom apetite")}
